...
export const useEditor = ({ today }) => {
  ...
  function pauseEditor() {
    console.log('EDITOR -> PAUSE EDITOR ->')
    setActivity({ isActive: false, startTime: '' })
    setPause({ isPaused: true, requireManualUnpause: false })
  }

  function unpauseEditor() {
    console.log('EDITOR -> UNPAUSE EDITOR ->')
  ...
  function getActivityFromQuery(activityLogs) {
    console.log('EDITOR -> getActivityFromQuery ->')
